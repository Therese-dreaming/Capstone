...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 mb-2">All Notifications</h1>
                <p class="text-gray-600">Manage and view all your notifications</p>
            </div>
            <div class="flex flex-col sm:flex-row gap-3">
                <button id="markAllReadBtn" class="inline-flex items-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    Mark All as Read
                </button>
                <a href="{{ route('my.tasks') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Filters -->
        <form method="GET" action="{{ route('notifications.all') }}" class="bg-gray-50 rounded-lg p-4 mb-6" id="filterForm">
            <div class="flex flex-col sm:flex-row gap-4">
                <div class="flex-1">
                    <label for="statusFilter" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                    <select name="status" id="statusFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div class="flex-1">
                    ...
                    <select name="type" id="typeFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div class="flex-1">
                    ...
                    <select name="date" id="dateFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div class="flex items-end">
                    <button type="submit" class="px-6 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200" id="applyFiltersBtn">
            ...
            @if(request('status') || request('type') || request('date'))
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <a href="{{ route('notifications.all') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-800">
        ...
        @if(request('status') || request('type') || request('date'))
            <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('notifications.all') }}" class="text-sm text-blue-600 hover:text-blue-800 underline">
                        Clear All
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-bold text-blue-900">{{ $filteredTotal }}</p>
                        @if(request('status') || request('type') || request('date'))
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-red-600">Unread</p>
                        <p class="text-2xl font-bold text-red-900" id="unreadCount">{{ $filteredUnread }}</p>
                        @if(request('status') || request('type') || request('date'))
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-bold text-green-900" id="readCount">{{ $filteredRead }}</p>
                        @if(request('status') || request('type') || request('date'))
                ...
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        @if(request('status') || request('type') || request('date'))
                            ...
                            <a href="{{ route('notifications.all') }}" class="text-red-600 hover:text-red-800">Clear filters</a> to see all notifications.
                        @else
