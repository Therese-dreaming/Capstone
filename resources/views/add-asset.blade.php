                            ...
                            <div>
                                ...
                                <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm md:text-base text-blue-700">System Serial Number will be automatically generated in format: ASST-YYYYMMDD-XXXX</span>
                                    </div>
                                </div>

                                <div class="mt-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Manufacturer Serial Number (Optional)</label>
                                    <input type="text" name="manufacturer_serial_number" value="{{ old('manufacturer_serial_number') }}" 
                                    ...
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500">Enter the serial number provided by the manufacturer (e.g., for RAM modules, hard drives, etc.). This is separate from the system-generated serial number.</p>
                                </div>
                            </div>
                        </div>
                    </div>
