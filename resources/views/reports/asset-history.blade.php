    ...
    <div class="p-6">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="grid grid-cols-6 w-full gap-1">
                        ...
                        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="date" id="start_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                                </div>
                                <div>
                                    <label for="end_date" class="block text-sm font-medium text-gray-700 mb-1">End Date</label>
                                    <input type="date" id="end_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring focus:ring-red-200">
                                </div>
