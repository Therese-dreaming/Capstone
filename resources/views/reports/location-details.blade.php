...
@section('content')
<div class="flex-1 p-4 md:p-6 mx-auto max-w-6xl md:max-w-full">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-4 md:p-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 sm:gap-0">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold">Location Details: {{ $location }}</h1>
                ...
                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
                    <a href="{{ route('reports.location') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 flex items-center justify-center sm:justify-start w-full sm:w-auto text-sm">
...
<style>
    @media print {
        ...
        button,
        .print-hide,
        .flex.flex-col.sm\:flex-row.space-y-3.sm\:space-y-0.sm\:space-x-4.w-full.sm\:w-auto, /* Hide button group container */
