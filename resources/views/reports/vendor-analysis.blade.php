    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 md:gap-0">
                ...
                <button type="button" onclick="openSignatureModal()" class="print:hidden inline-flex items-center px-6 py-3 bg-red-800 text-white text-sm font-medium rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors duration-200 shadow-lg hover:shadow-xl">
