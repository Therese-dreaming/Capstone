    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold">{{ $category->name }} Assets</h1>
                    <p class="text-gray-600">Total Assets: {{ $assets->count() }}</p>
                </div>
                <div class="flex space-x-3">
                    <a href="{{ route('reports.category') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 flex items-center">
