            ...
            <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div class="flex space-x-2">
                        <input type="date" name="start_date" value="{{ request('start_date') }}" class="h-10 w-full md:w-auto px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors">
                        <input type="date" name="end_date" value="{{ request('end_date') }}" class="h-10 w-full md:w-auto px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors">
                    </div>
                </div>
                <div class="transform transition-all duration-300 hover:scale-[1.02]">
