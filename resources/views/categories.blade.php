            ...
            <div class="bg-gray-50 rounded-xl p-4 md:p-6 hover:bg-gray-100 transition-colors duration-200 border border-gray-200">
                <div class="flex justify-between items-start mb-3 md:mb-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        @php
                            $hasReferences = $category->assets()->exists() || $category->repairRequests()->exists();
                        @endphp
                        ...
                        @if($hasReferences)
                            <div class="relative group">
                                <button type="button" 
                                        ...
                                        title="Cannot delete category - has associated records"
                                        disabled>
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                @if($hasReferences)
                                    <div class="relative group inline-block">
                                        <button type="button" 
                                                class="text-gray-400 bg-gray-100 p-2 rounded cursor-not-allowed" 
                                                title="Cannot delete category - has associated records"
                                                disabled>
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
