    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold">Scheduled Maintenance Tasks</h2>
                <span class="text-sm text-gray-600">{{ $maintenanceTasks->count() }} Tasks</span>
            </div>
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="mt-2 text-gray-600">No maintenance tasks assigned.</p>
                </div>
            @endif
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold">Active Repair Requests</h2>
                <span class="text-sm text-gray-600">{{ $repairRequests->count() }} Requests</span>
            </div>
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="mt-2 text-gray-600">No repair requests assigned.</p>
                </div>
            @endif
        </div>
    </div>
